...
class Game():
    ...
    def move( self, moves ):
        ...
        if moves[0] == 'f' and self.starsPositions[0] == (1,0) and len(self. starsPositions) == 1:
                return 1
        ...
        if  moves[0] == 'f' and moves[1] == 'f' and  self.starsPositions[0] == (1,0) and self.starsPositions[1] == (2,0) and len(self.starsPositions) == 2:
                return 2
